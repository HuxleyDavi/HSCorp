...
<body>
	...
	<section class="descricao-danki">
		<div class="container">
			<p>Com anos de experiência em desenvolvimento web e automação de marketing, a <b>DankiCode</b> traz soluções que ajudam o seu time a vender mais tanto em segmentos B2C quanto B2B.</p>
		</div><!-- container -->
	</section>
	...
	<section class="servicos">
		<div class="container">
			<div class="title-servicos">
				<h3>Como podemos ajudar a sua empresa<br /><i class="fa fa-angle-down"></i></h3>
			</div>
	...
	<footer>
		<div class="container">
			<div class="box-footer">
				<h2>Endereço</h2>
				<p>Rua João Cavati Sobrinho, 62 - Santa Cruz, Caratinga/MG, 35300-194, Brasil</p>
			</div>
			<div class="box-footer">
				<h2>Telefone</h2>
				<p>(33) 99802-3970</p>
